...
[![Certbot](https://img.shields.io/badge/certbot-%20-blue?style=flat-square&logo=letsencrypt)](https://certbot.eff.org/)

***

## Функционал:

- Проект Meow Moments позволяет пользователям делиться своими фотографиями
...
**backend** вы можете найти в соответствующих директориях репозитория в 
файлах README.md
...
домашней директории директорию с названием **MeowMoments**.
...
(Например **your_name/MeowMoments_backend**)
...
После этого можно вернуться на удалённый сервер, в директорию **MeowMoments** и
